...
public record PetCreateDto(
        ...
        @Pattern(regexp = "[a-zA-Z0-9-]+", message = ONLY_LETTERS)
        @Schema(
                description = "Pet secondary breed id",
                example = "12789-1234-1234-12345")
        ...
        @Pattern(regexp = "[a-zA-Z0-9-]+", message = ONLY_LETTERS)
        @Schema(
                description = "Pet primary color id",
                example = "12789-1234-1234-12345")
        String primaryColor,

        @Pattern(regexp = "[a-zA-Z0-9-]+", message = ONLY_LETTERS)
        @Schema(
                description = "Pet secondary color id",
                example = "12789-1234-1234-12345")
        String secondaryColor,

        @Pattern(regexp = "[a-zA-Z0-9-]+", message = ONLY_LETTERS)
        @Schema(
                description = "Pet tertiary color id",
                example = "12789-1234-1234-12345")
        ...
        @Schema(
                ...
                example = "A friendly and loving dog.")
        String description,
